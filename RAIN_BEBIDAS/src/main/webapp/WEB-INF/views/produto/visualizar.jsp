...
<div class="container">
	...
	<div class="row justify-content-center titulo">
		<div class="col-md-12 col-lg-9">
			<button type="button" class="btn btn-primary mb-4" onclick="location.href='/produto/novo'">Novo</button>
			<button type="button" class="btn btn-primary mb-4" onclick="location.href='/categorias'">Categorias de Produtos</button>
		</div>
	</div>
